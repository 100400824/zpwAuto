...
public class ReportTemplate {
    ...
    public static String filePath = System.getProperty("user.dir" )+ "\\APITest\\test-output\\";

    public static void main(String[] args) throws Exception{
        System.out.println(filePath);
        OperationFile.write(filePath + "APITest.html",template());
    }

    public static String template(){
        String tp1 = "<html><head>\n" +
                "\t<meta charset=\"utf-8\"> \n" +
                ...
                "\t\t\t\t\t<td class=\"step-details\"><pre>"+ "reportTemplateFailDetail" +
                "</pre></td>\n" +
                "\t\t\t\t</tr>\n" +
                "\t\t\t</tbody>\n" +
                "\t\t</table>\n" +
                ...
                String tp2 =
                "\t\t\t\t<li class=\"test displayed  pass\" status=\"pass\" bdd=\"false\" test-id=\"6\">\n" +
                "\t\t\t\t\t<div class=\"test-heading\">\n" +
        ...
        return tp1 + allListTemplateFail + tp2;
    }
}
